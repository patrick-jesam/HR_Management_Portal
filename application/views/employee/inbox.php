...
<div class="col-sm-12">
    <div class="content-wrapper">
        ...
        <span >
            <b style="font-size: 25px;"><?= lang('inbox')?></b> (<small><strong><?php
                        ...
                        <div class="box box-primary" >                    
                            <div class="box-body" >
                                <div class="mailbox-controls">
                                    ...
                                    <a href="<?php echo base_url() ?>employee/dashboard/compose" class="btn btn-danger"><?= lang('compose')?> +</a>                                
                                </div>
                                <br />
                                            ...
                                            if (!empty($get_inbox_message)):foreach ($get_inbox_message as $v_inbox_msg):
                                                    if (!empty($v_inbox_msg->to)) {
                                                        ...
                                                        <tr>                                                                                                                                
                                                            ...
                                                            <td class="mailbox-name"><a href="<?php echo base_url() ?>employee/dashboard/read_inbox_mail/<?php echo $v_inbox_msg->inbox_id ?>"><?php
