                        ...
                        <div align="center">
                            ...
                            <div class="tbl2">
                                <table>
                                    ...
                                    <tr>
                                        <td style="background: #CECECE"><strong class="pull-right" style="font-size: 14px;"><?= lang('net_salary')?>:&nbsp;</strong></td>
...
<div class="show_print">
    ...
    if (!empty($genaral_info)) {
        ...
        ?>
        <p style="margin-top: 10px;font: 12px lighter;">Human Resource Management Lite</p>
        <?php
    }
    ?>
</div>
