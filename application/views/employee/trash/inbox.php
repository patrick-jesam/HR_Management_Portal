...
<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?php echo base_url() ?>employee/dashboard/delete_mail/inbox" >
            <!-- Main content -->                 
                            ...
                            <tbody style="font-size: 13px">
                                <?php if (!empty($get_inbox_message)):foreach ($get_inbox_message as $v_inbox_msg): ?>
                                        <tr>                                                                                                                                
                                            ...
                                            <td class="mailbox-name"><a href="<?php echo base_url() ?>employee/dashboard/index/read_inbox_mail/<?php echo $v_inbox_msg->inbox_id ?>"><?php
                                            ...
                                            <td><a class="btn btn-primary btn-xs" href="<?php echo base_url() ?>employee/dashboard/restore/inbox/<?php echo $v_inbox_msg->inbox_id ?>" data-toggle="tooltip" data-placement="top"  title="Restore"><i class="fa fa-retweet"></i></a>                                                
                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>employee/dashboard/delete_mail/inbox/deleted/<?php echo $v_inbox_msg->inbox_id ?>" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" data-toggle="tooltip" data-placement="top"  title="Permanent&nbsp;Delete"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>                  
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
