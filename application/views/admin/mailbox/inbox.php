                                ...
                                <tbody style="font-size: 13px">
                                    <?php if (!empty($get_inbox_message)):foreach ($get_inbox_message as $v_inbox_msg): ?>
                                            <tr>                                                                                                                                
                                                ...
                                                <td class="mailbox-name"><a href="<?php echo base_url() ?>admin/mailbox/read_inbox_mail/<?php echo $v_inbox_msg->inbox_id ?>"><?php
                                                        $string = (strlen($v_inbox_msg->from) > 13) ? substr($v_inbox_msg->from, 0, 10) . '...' : $v_inbox_msg->from;
