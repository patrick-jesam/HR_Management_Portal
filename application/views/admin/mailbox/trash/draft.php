            ...
            <div class="box box-danger">                    
                <div class="box-body no-padding">
                    <div class="mailbox-controls">
                        ...
                        <div class="btn-group">
                            <button onclick="return confirm('<?= lang('delete_alert')?>');" data-toggle="tooltip" data-placement="top"  title="Permanent&nbsp;Delete" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button>                                
                        </div><!-- /.btn-group -->
                            ...
                            <tbody style="font-size: 13px">
                                <?php if (!empty($draft_message)):foreach ($draft_message as $v_draft_msg): ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() ?>admin/mailbox/compose/<?php echo $v_draft_msg->draft_id ?>"><?php
