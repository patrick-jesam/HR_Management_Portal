                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php
                            ...
                            ?></span>
                        <a href="<?php echo base_url() ?>admin/employee/employee_list" class="small-box-footer"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div><!-- end Total Employee-->
                <!-- Total Award-->
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php
                            ...
                            ?></span>
                        <a href="<?php echo base_url() ?>admin/employee/employee_award" class="small-box-footer"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div><!-- End total Award -->
                <!-- Total Employee-->
                <?php
